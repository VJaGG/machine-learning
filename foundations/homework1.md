...
7、$2^L$  
8、$\Bbb{E_{f}}\lbrace \mit{E_{OTS}}\left(\cal{A_{1}}\left(\cal{D}\right), f\right)\rbrace =\Bbb{E_{f}}\lbrace  \mit{E_{OTS}}\left(\cal{A_{2}}\left(\cal{D}\right), f\right)\rbrace $  
9、**0.24**  
...
15\tilde17、[running perceptron](code/perceptron.py)  
18\tilde20、[running pocket](code/pocket.py)
